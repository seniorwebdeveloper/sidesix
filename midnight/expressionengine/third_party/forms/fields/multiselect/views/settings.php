<tr>
	<td><?=lang('form:enhanced_ui')?> <span class="ToolTip" rel="enhanced_ui" title="<?=lang('form:enhanced_ui')?>"></span></td>
	<td>
		<?=form_radio($form_name_settings.'[enhanced_ui]', 'no', ((isset($enhanced_ui) == TRUE && $enhanced_ui == 'no') ? TRUE : FALSE))?> <?=lang('form:no')?>
		<?=form_radio($form_name_settings.'[enhanced_ui]', 'yes', ((isset($enhanced_ui) == FALSE OR $enhanced_ui == 'yes') ? TRUE : FALSE))?> <?=lang('form:yes')?>
	</td>
</tr>
